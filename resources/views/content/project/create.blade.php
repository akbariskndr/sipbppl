                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        <h4 class="ml-3 card-title">Buat Proyek Baru</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <div class="input-group date">
                                                        <input type="text" id="start_date" name="start_date" class="form-control datepicker" value="{{ date('d-m-Y') }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <select name="instance_level" id="instance_level" class="form-control" required>
                                                        <option disabled selected>Silahkan pilih</option>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <select name="complexity_level" id="complexity_level" class="form-control" required>
                                                        <option disabled selected>Silahkan pilih</option>
                                                        <option value="1">Sangat Mudah</option>
                                                        <option value="2">Mudah</option>
                                                        <option value="3">Biasa</option>
                                                        <option value="4">Rumit</option>
                                                        <option value="5">Sangat Rumit</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                ...
                                <div class="card-footer">
                                    <div class="row justify-content-end">
                                        <div class="col-md-2">
                                            <button class="btn btn-success btn-block" type="submit" name="submit_option" value="1">Simpan & Hitung</button>
                                        </div>
                                        <div class="col-md-2">
                                            <button class="btn btn-primary btn-block" type="submit" name="submit_option" value="2">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-11">
                            <div class="row form-group">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="feature_name" class="form-control" required>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-7">
                                    <label class=" form-control-label">Prioritas</label>
                                    <select name="feature_priority" id="feature_priority" class="form-control">
                                        <option disabled selected>Silahkan pilih</option>
